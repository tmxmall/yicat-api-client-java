...
import vip.yicat.client.document.model.CoverDocumentRequest;
import vip.yicat.client.document.model.ExportDocumentRequest;
...
public class FileSample {
    ...
    public static void main(String[] args) {
        //创建项目
        ApiTranslationProject apiTranslationProject = CommonMethod.createProject(client, "project01", "zh-Hans", Arrays.asList("en-US"), "笔记01");
        //上传文件
        ...
        //添加文档到项目中
        List<ApiTranslationDocumentWithSettings> apiTranslationDocumentWithSettingsList = CommonMethod.createDocument(client, apiTranslationProject, apiUploadFileInfo);
        //获取文档列表
